...
export default function DashboardContent() {
  ...
  return (
    <div className="space-y-6 xs:space-y-8">
      ...
      <div className="bg-white backdrop-blur-sm rounded-xl p-4 xs:p-5 sm:p-6 border border-orange-100 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 xs:gap-6">
        {/* Weather section */}
        <div className="bg-white backdrop-blur-sm rounded-xl p-4 xs:p-5 sm:p-6 border border-orange-100 shadow-sm lg:col-span-1">
          <h2 className="text-lg xs:text-xl font-extralight text-orange-700 mb-3 xs:mb-4 flex items-center gap-2">
          ...
          <div className="space-y-3 xs:space-y-4">
            <div className="flex items-center justify-between px-3 xs:px-4 py-2 rounded-lg bg-white border border-orange-100">
        ...
        {/* User Schedule */}
        <div className="bg-white backdrop-blur-sm rounded-xl p-4 xs:p-5 sm:p-6 border border-orange-100 shadow-sm md:col-span-3">
          <h2 className="text-lg xs:text-xl font-extralight text-orange-700 mb-3 xs:mb-4 flex items-center gap-2">
          ...
          <div className="space-y-4">
            <div className="p-3 xs:p-4 rounded-lg bg-white border border-orange-100 space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                {daysOff.length > 0 ? (
                  daysOff.map((day, index) => (
                    <div 
                      key={index}
                      className="px-3 py-1 rounded-full bg-white text-xxs xs:text-xs font-light text-orange-700 border border-orange-100"
                    >
